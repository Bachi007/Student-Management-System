...
PreparedStatement stmt=con.prepareStatement("update std set admno=?,name=?,course=?,batch=?,email=?,phone=?,adr=? where admno	='"+a+"'");
...
%>
<a href="update.html"><h3 ALIGN="CENTER" COLOR="RED">BACK TO UPDATE</h3></a>
<a href="stup.html"><h3 ALIGN="CENTER" COLOR="RED">BACK TO  REGUPDATE</h3></a>
</body>
</html>