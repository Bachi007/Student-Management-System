...
<% 
	...
	%>
	<center><font color='blue' size='6'>FRIST SEM MARKS UPDATE</font></center></h2><br>
<center><form action="1htup.jsp"   name="f2" onSubmit="return checkf(this)" method="post">
<table>
<tr><td><b>NAME:&nbsp;</b><td><input type="text" pattern="[a-zA-z]+{50}" name="name"size="25"style="text-transform:uppercase" value="<%= res.getString(1) %>">
...
<tr><td><b>DMS:&nbsp;</b><td><input type="number" min="0"max="100" name="sub1"size="25" id="sub1"value="<%= res.getInt(3) %>">
<tr><td><b>PS:&nbsp;</b><td><input type="number" min="0"max="100" name="sub2" size="25" id="sub2"value="<%= res.getInt(4) %>">
<tr><td><b>IP:&nbsp;</b><td><input type="number" min="0"max="100"name="sub3"size="25" id="sub3" value="<%= res.getInt(5) %>">
<tr><td><b>CO:&nbsp;</b><td><input type="number" min="0"max="100" name="sub4"size="25" id="sub4" value="<%= res.getInt(5) %>">
<tr><td><b>OM:&nbsp;</b><td><input type="number" min="0"max="100" name="sub5"size="25" id="sub5" value="<%= res.getInt(6) %>">
<tr><td><b>S/W LAB1:&nbsp;</b><td><input type="number" min="0"max="100" name="lab1"size="25" id="lab1" value="<%= res.getInt(8) %>">
<tr><td><b>IP LAB:&nbsp;</b><td><input type="number" min="0"max="100" name="lab2"size="25" id="lab2" value="<%= res.getInt(9) %>">
<tr><td><b>PC H/W LAB:&nbsp;</b><td><input type="number" min="0"max="100" name="lab3"size="25" id="lab3" value="<%= res.getInt(10) %>">
...
<tr><td><b>RESULT:&nbsp;</b><td><input type="text" id="rtype" name="rtype"size="25"value="<%= res.getString(13) %>">
</td></tr>
...
<a href="1htup.html"><h3 align="CENTER" color="red" FONT="7">BACK TO MARKS DETAILS</h3></a>
</p></body>
</html>