...
<% 
	...
	%>
	<center><font color='blue' size='6'>SECOND SEM MARKS UPDATE</font></center></h2><br>
<center><form action="2htup.jsp"   name="f2" onSubmit="return checkf(this)" method="post">
<table>
...
<tr><td><b>DS:&nbsp;</b><td><input type="number" min="0"max="100" name="sub2" size="25"id="sub2" value="<%= res.getInt(4) %>">
<tr><td><b>OS:&nbsp;</b><td><input type="number" min="0"max="100"name="sub3"size="25"id="sub3"value="<%= res.getInt(5) %>">
<tr><td><b>FS:&nbsp;</b><td><input type="number" min="0"max="100" name="sub4"size="25"id="sub4" value="<%= res.getInt(6) %>">
<tr><td><b>AFM:&nbsp;</b><td><input type="number" min="0"max="100" name="sub5"size="25"id="sub5" value="<%= res.getInt(7) %>">
<tr><td><b>S/W LAB2:&nbsp;</b><td><input type="number" min="0"max="100" name="lab1"size="25"id="lab1" value="<%= res.getInt(8) %>">
<tr><td><b>FS LAB:&nbsp;</b><td><input type="number" min="0"max="100" name="lab2"size="25"id="lab2" value="<%= res.getInt(9) %>">
<tr><td><b>DS LAB:&nbsp;</b><td><input type="number" min="0"max="100" name="lab3"size="25"id="lab3" value="<%= res.getInt(10) %>">
