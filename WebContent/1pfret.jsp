...
ResultSet res=ps.executeQuery("select * from sem1 where rtype ='" + r + "'");
if(!res.next())
{
...
<% 
  ...
  <tr> 
    <td colspan="15"><div align="center"><b><u>I SEM MARKS</u></b></div></td>
  </tr>
  <tr> 
...
<p><br><a href="admin.html"><h3 align="CENTER"><font color="red" size="7">BACK TO ADMIN</font></h3></a>
