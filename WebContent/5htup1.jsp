...
<% 
	...
	%>
	<center><font color='blue' size='6'>FIFTH SEM MARKS UPDATE</font></center></h2><br>
<center><form action="5htup.jsp"   name="f2" onSubmit="return checkf(this)" method="post">
<table>
<tr><td><b>NAME:&nbsp;</b><td><input type="text" pattern="[a-zA-z]" name="name"size="25" value="<%= res.getString(1) %>">
<tr><td><b>Hallticket NO:&nbsp;</b><td><input type="text" minlength="10" maxlength="10"  name="hall"size="25" value="<%= res.getString(2) %>">
<tr><td><b>CG:&nbsp;</b><td><input type="number" min="0"max="100" name="sub1"size="25" id="sub1"  value="<%= res.getInt(3) %>">
<tr><td><b>OOSD:&nbsp;</b><td><input type="number" min="0"max="100" name="sub2" size="25"id="sub2"  value="<%= res.getInt(4) %>">
<tr><td><b>SP:&nbsp;</b><td><input type="number" min="0"max="100"name="sub3"size="25"id="sub3"  value="<%= res.getInt(6) %>">
<tr><td><b>DS:&nbsp;</b><td><input type="number" min="0"max="100" name="sub4"size="25" id="sub4"  value="<%= res.getInt(5) %>">
<tr><td><b>MMS:&nbsp;</b><td><input type="number" min="0"max="100" name="sub5"size="25"id="sub5"  value="<%= res.getInt(7) %>">
<tr><td><b>S/W LAB5:&nbsp;</b><td><input type="number" min="0"max="100" name="lab1"size="25"id="lab1"  value="<%= res.getInt(8) %>">
<tr><td><b>S/W LAB6:&nbsp;</b><td><input type="number" min="0"max="100" name="lab2"size="25"id="lab2"  value="<%= res.getInt(9) %>">
<tr><td><b>MINOR:&nbsp;</b><td><input type="number" min="0"max="100" name="lab3"size="25"id="lab3" value="<%= res.getInt(10) %>">
...
<a href="5htup.html"><h3 align="CENTER" color="red" FONT="7">BACK TO MARKS DETAILS</h3></a>
</p></body>
</html>