...
try{
	...
	PreparedStatement stmt=con.prepareStatement("update sem2 set name=?,hall=?,sub1=?,sub2=?,sub3=?,sub4=?,sub5=?,lab1=?,lab2=?,lab3=?,total=?,per=?,rtype=? where hall='"+h+"'");
...
%>
<a href="update.html"><h3 align="CENTER" color="red" FONT="5">BACK TO UPLOADS</h3></a>
<a href="2htup.html"><h3 align="CENTER" color="red" FONT="5">BACK TO MRKS UPLOADS</h3></a>
