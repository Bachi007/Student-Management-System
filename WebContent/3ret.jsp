...
<% 
	...
	%><center><FONT COLOR='RED'><H1>III SEMISTER MARKS STUDENT DETAILS</H1></FONT></center><br> <br>
	<
  ...
  <tr> 
    ...
    <td width="127">DBMS</td>
    <td width="127">DCCN</td>
    <td width="127">SE</td>
   <td width="127">DAA</td>
   <td width="127">TCCE</td>
   <td width="127">S/W LAB3</td>
   <td width="127">SE LAB</td>
   <td width="127">DBMS LAB</td>
