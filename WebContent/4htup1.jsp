...
function add()
{
var a,b,c,d,e,f,g,h,i,j k="pass",l="fail";
...
<% 
	...
	%>
	<center><font color='blue' size='6'>FOURTH SEM MARKS UPDATE</font></center></h2><br>
<center><form action="4htup.jsp"   name="f2" onSubmit="return checkf(this)" method="post">
<table>
<tr><td><b>NAME:&nbsp;</b><td><input type="text"name="name"size="25" value="<%= res.getString(1) %>">
<tr><td><b>Hallticket NO:&nbsp;</b><td><input type="text" minlength="10" maxlength="10" name="hall"size="25" value="<%= res.getString(2) %>">
<tr><td><b>PM:&nbsp;</b><td><input type="number" min="0"max="100" name="sub1"size="25" id="sub1" value="<%= res.getInt(3) %>">
<tr><td><b>DMDW:&nbsp;</b><td><input type="number" min="0"max="100" name="sub2" size="25"id="sub2" value="<%= res.getInt(4) %>">
<tr><td><b>WP:&nbsp;</b><td><input type="number" min="0"max="100"name="sub3"size="25"id="sub3" value="<%= res.getInt(5) %>">
<tr><td><b>UID:&nbsp;</b><td><input type="number" min="0"max="100" name="sub4"size="25" id="sub4" value="<%= res.getInt(6) %>">
<tr><td><b>E-COMMERCE:&nbsp;</b><td><input type="number" min="0"max="100" name="sub5"size="25"id="sub5" value="<%= res.getInt(7) %>">
<tr><td><b>S/W LAB4:&nbsp;</b><td><input type="number" min="0"max="100" name="lab1"size="25"id="lab1" value="<%= res.getInt(8) %>">
<tr><td><b>WP LAB:&nbsp;</b><td><input type="number" min="0"max="100" name="lab2"size="25"id="lab2" value="<%= res.getInt(9) %>">
<tr><td><b>DDMDW LAB:&nbsp;</b><td><input type="number" min="0"max="100" name="lab3"size="25"id="lab3"value="<%= res.getInt(10) %>">
...
<a href="4htup.html"><h3 align="CENTER" color="red" FONT="7">BACK TO MARKS DETAILS</h3></a>
</p></body>
</html>