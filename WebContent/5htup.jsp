...
try{
	...
	PreparedStatement stmt=con.prepareStatement("update sem5 set name=?,hall=?,sub1=?,sub2=?,sub3=?,sub4=?,sub5=?,lab1=?,lab2=?,lab3=?,total=?,per=?,rtype=? where hall='"+h+"'");
...
if(ac>0)
{ out.println("<font color='black' size='6'><center>successfully Uploaded the fifth semister marks details</center></font>");
	}
con.close();
}catch(Exception e)
{
...
<a href="5htup.html"><h3 align="CENTER" color="red" FONT="7">BACK TO MRKS UPLOADS</h3></a>
